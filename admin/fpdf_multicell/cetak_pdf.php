...
class FPDF_AutoWrapTable extends FPDF {
	...
	public function rptDetailData () {
		...
		//header
		$this->Image('img/261218spl-logo.png',30,30,60,40);
		$this->SetFont("", "B", 15);
		$this->SetX($left); $this->Cell(0, 20, 'PT. SINARMAS PELANGI', 0, 1,'C');
		$this->SetFont("", "", 9);
		$this->SetX($left); $this->Cell(0, 20, 'Alamat: Jl. Tanah Tinggi Timur No. 1 A, Harapan Mulia Kemayoran, Jakarta Pusat, Indonesia 10640', 0, 1,'C');
		$this->SetFont("", "", 15);
		...
		$this->Ln(10);
		$this->SetFont("", "B", 12);
		$this->SetX($left); $this->Cell(0, 20, 'LAPORAN DATA PELANGGAN', 0, 1,'C');
		$this->Ln(10);
		...
		$this->SetX($left += 23); $this->Cell(75, $h, 'ID PELANGGAN', 1, 0, 'C',true);
		$this->SetX($left += 75); $this->Cell(100, $h, 'NAMA PELANGGAN', 1, 0, 'C',true);
		$this->SetX($left += 100); $this->Cell(150, $h, 'TELEPON', 1, 0, 'C',true);
		$this->SetX($left += 150); $this->Cell(150, $h, 'ALAMAT', 1, 1, 'C',true);
		
		//$this->Ln(20);
		
		$this->SetFont('Arial','',9);
		$this->SetWidths(array(23,75,100,150,150));
