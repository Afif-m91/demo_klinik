...
class Pengiriman_Model extends CI_Model
{
	...
	function getAll($filter = null,$limit = 20,$offset = 0, $orderBy, $orderType)
	{
		...
		$query = $this->db->query("SELECT SQL_CALC_FOUND_ROWS pg.*,k.nama_kategori kategori,k.keterangan kategori_keterangan,kr.nama kurir,p.nama pelanggan,p.alamat
								   ,group_concat(concat(dp.id_barang,'|',b.nama,'|',k.nama_kategori,'|',b.satuan,'|',dp.qty,'|',b.del_no) 
