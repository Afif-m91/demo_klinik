<?php
class Pasien_Online_Model extends CI_Model
{
	var $table  = 'pasien_online';
	var $key  = 'id_pasien';
...
// Listing
	...
	{
		$query = $this->db->query(" ( SELECT  ".$this->key." FROM pasien where ".$this->key." = '".$this->db->escape_str(strtolower($id))."' ) ");
		$result = $query->row();
		$query->free_result();
	...
	function authenticate($username,$password)
    {
		...
		$this->db->where('id_pasien', $this->db->escape_str($username));
