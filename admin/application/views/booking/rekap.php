								...
								<div class="panel-heading">
									<div class="row">
										<div class="col-md-5  pull-right">
												...
												<button type="submit" class="btn btn-danger" name="action" value="pdf"  target="_blank" >Export to PDF</button>
												
												<!-- <button class="btn btn-warning btn-sm" type="button" data-toggle="dropdown"> Export
										<span class="caret"></span></button>
											<ul class="dropdown-menu">
												<li> <a href="<?php echo site_url("kurir/export_excel")?>" name="action" value="excel" class="fa fa-file-excel-o" style="color:green">
												&nbsp;Export Excel</a></li>
