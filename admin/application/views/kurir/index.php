					...
					<div class="box-header">
									 ...
									 <a href="<?php echo site_url("kurir/manage")?>" class="btn btn-success btn-sm">Add</a>
										...
										<span class="caret"></span></button>
											<ul class="dropdown-menu">
												...
												<!-- <li><?php echo anchor('kurir/laporan_pdf','Export PDF', 
												array('target' => '_blank')); ?></li> -->
											</ul>

								
									 <!-- <button type="submit" class="btn btn-success" name="action" value="excel">Export to Excel</button>
									 <a href="<?php echo site_url("kurir/export_excel") ?>" class="btn btn-warning btn-sm" >
						...
						foreach($data as $dt): ?>
						  <tr>
							...
							<th>
								<a class="btn btn-warning btn-xs" href="<?php echo site_url("kurir/manage")."/". $dt['id_kurir']; ?>">
								<span class="glyphicon glyphicon-edit"></span></a>
								<a class="btn btn-danger btn-xs" data-href="<?php echo site_url("kurir/delete")."/". $dt['id_kurir'];?>" 
