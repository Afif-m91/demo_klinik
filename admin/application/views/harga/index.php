				...
				<div class="box box-primary">
					<div class="box-header">
						<div class="filter-wrapper box-tools pull-right">
								<form class="form-inline" method="get" action="<?php echo site_url("harga")?>" >
									 ...
									 <a href="<?php echo site_url("harga/manage")?>" class="btn btn-success btn-sm">Add</a>
									
									 <!-- <button type="submit" class="btn btn-success" name="action" value="excel">Export to Excel</button> -->
									 <a href="<?php echo site_url("harga/export_excel") ?>" class="btn btn-warning btn-sm" >
						...
						foreach($data as $dt): ?>
						  <tr>
						 	<td><?php echo $no++;?></td>
							<td><?php echo $dt['id_harga'];?></td>
							<td><?php echo $dt['kecamatan'];?></td>
							<td><?php echo $dt['harga'];?></td>
							<td><?php echo $dt['moda'];?></td>
							<th>
								<a class="btn btn-warning btn-xs" href="<?php echo site_url("harga/manage")."/". $dt['id_harga']; ?>">
								<span class="glyphicon glyphicon-edit"></span></a>
								<a class="btn btn-danger btn-xs" data-href="<?php echo site_url("harga/delete")."/". $dt['id_harga'];?>" 
