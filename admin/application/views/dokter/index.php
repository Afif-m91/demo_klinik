				...
				<div class="box box-primary">
					<div class="box-header">
						<div class="filter-wrapper box-tools pull-right">
								<form class="form-inline" method="get" action="<?php echo site_url("dokter")?>" >
								 <div class="form-group">
										<input type="text" class="form-control input-sm" id="keyword" placeholder="Cari.." name="keyword" value="<?php echo $this->input->get('keyword');?>">
								 </div>
									 <button type="submit" class="btn btn-primary btn-sm glyphicon glyphicon-search"></button>&nbsp; &nbsp;
									 <a href="<?php echo site_url("dokter/manage")?>" class="btn btn-success btn-sm"> Add </a>
								</form>
						</div>
					</div>
						...
						<?php foreach($data as $dt): ?>
						  <tr>
							...
							<th>
								<a class="btn btn-warning btn-xs" href="<?php echo site_url("dokter/manage")."/". $dt['id_dokter']; ?>">
								<span class="glyphicon glyphicon-edit"></span></a>
								<a class="btn btn-danger btn-xs" data-href="<?php echo site_url("dokter/delete")."/". $dt['id_dokter'];?>"
