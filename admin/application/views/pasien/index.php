				...
				<div class="box box-primary">
					<div class="box-header">
						<div class="filter-wrapper box-tools pull-right">
								<form class="form-inline" method="get" action="<?php echo site_url("pasien")?>" >
									 ...
									 <a href="<?php echo site_url("pasien/manage")?>" class="btn btn-success btn-sm">Add</a>

										
										<button class="btn btn-warning btn-sm" type="button" data-toggle="dropdown"> Export
										<span class="caret"></span></button>
											<ul class="dropdown-menu">
												<li><a href="<?php echo site_url("pasien/export_excel")?>" class="fa fa-file-excel-o" style="color:green">
												&nbsp;Export Excel</a></li>
												<li><a href="<?php echo base_url("kurir_pdf/cetak_pdf.php") ?>"class="fa fa-file-pdf-o" style="color:red"
												 target="_blank">&nbsp; Export PDF</a></li>
												
												<!-- <li><?php echo anchor('pasien/laporan_pdf','Export PDF', 
						...
						foreach($data as $dt): ?>
						  <tr>
							...
							<th>
								<a class="btn btn-warning btn-xs" href="<?php echo site_url("pasien/manage")."/". $dt['id_pasien']; ?>">
								<span class="glyphicon glyphicon-edit"></span></a>
								<a class="btn btn-danger btn-xs" data-href="<?php echo site_url("pasien/delete")."/". $dt['id_pasien'];?>" 
