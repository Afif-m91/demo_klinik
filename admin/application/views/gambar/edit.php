					...
					<form  class="form-horizontal" method="post" action="<?php echo site_url("gambar/save")?>" enctype="multipart/form-data" >
						<!-- <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $data->id_slider; ?>" > -->
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
								  <input type="text" class="form-control"  required="required" id="nama_slider"  
								  name="nama_slider" placeholder="input nama" value="<?php $data['nama_slider'];?>"  >
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-4">
								  ...
								  placeholder="input keterangan" required="required"><?php  $data['nama_slider'];?></textarea>
								</div>
							</div>
							<div class="form-group">
