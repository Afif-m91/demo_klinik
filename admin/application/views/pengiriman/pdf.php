	...
	<table>
		<tr>
			<td width='450' align="center" valign='top'>
				<img class="img-logo" src="<?php echo base_url("assets/images")."/261218spl-logo.png"; ?>" width="100" height="90" />
				<div class='header-pt'>PT Sinarmas Pelangi</div>
				<div class='header-address'>Jl. Ciputat Raya No.14A </div>
				<div class='header-address'>Pondok Pinang - Jakarta Selatan</div>
				<div class='header-address'>021-7694659</div>
			</td>
			<td valign='top'>
