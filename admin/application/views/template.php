  ...
  <body class="hold-transition skin-blue layout-boxed sidebar-mini">
    <div class="wrapper">
      <header class="main-header">
        <!-- Logo -->
        <a href="" class="logo">
          <span class="logo-mini"><b>JMH</b></span>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
            ...
            <span class="icon-bar"></span>
            <span class="icon-bar"></span>
            <span class="logo-lg"><b> &nbsp; JAKARTA MEDICAL HOMECARE </b></span>          
          </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li ><a href="<?php echo site_url('spesialis')?>"><i class="fa fa-circle-o"></i> Spesialis</a></li>
				<!-- <li ><a href="<?php echo site_url('barang')?>"><i class="fa fa-circle-o"></i> Barang</a></li> -->
				<li ><a href="<?php echo site_url('dokter')?>"><i class="fa fa-circle-o"></i> Dokter</a></li>
      ...
      <?php if($CI->getStatus() == '1'): ?>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-globe"></i> <span>Data Pasien</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li ><a href="<?php echo site_url('pasien')?>"><i class="fa fa-circle-o"></i> Pasien</a></li>
				<li ><a href="<?php echo site_url('pasien_online')?>"><i class="fa fa-circle-o"></i>Data Pasien Online</a></li>
				<!-- <li ><a href="<?php echo site_url('dokter')?>"><i class="fa fa-circle-o"></i> Dokter</a></li>
				<li ><a href="<?php echo site_url('pasien')?>"><i class="fa fa-circle-o"></i> Pasien</a></li>
				<li ><a href="<?php echo site_url('pelanggan')?>"><i class="fa fa-circle-o"></i> Pelanggan</a></li>
				<li ><a href="<?php echo site_url('harga')?>"><i class="fa fa-circle-o"></i> Harga</a></li>
      ...
      <?php if($CI->getStatus() == '1' || $CI->getStatus() == '2'): ?>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-globe"></i> <span>Produk & Layanan</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li ><a href="<?php echo site_url('pengobatan')?>"><i class="fa fa-circle-o"></i> Pemeriksaan & Pengobatan</a></li>
				<li ><a href="<?php echo site_url('vaksin')?>"><i class="fa fa-circle-o"></i> Vaksin</a></li>
				<li ><a href="<?php echo site_url('fisioterapi')?>"><i class="fa fa-circle-o"></i> Fisioterapi</a></li>
				<li ><a href="<?php echo site_url('gizi')?>"><i class="fa fa-circle-o"></i> Konsultasi Gizi</a></li>
				<li ><a href="<?php echo site_url('abk')?>"><i class="fa fa-circle-o"></i>Konsultasi Psikologi ABK</a></li>
				<!-- <li ><a href="<?php echo site_url('harga')?>"><i class="fa fa-circle-o"></i> Harga</a></li> -->
      	<!-- <li ><a href="<?php echo site_url('user')?>"><i class="fa fa-circle-o"></i> User</a></li> -->
              </ul>
            </li>
      ...
      <?php if($CI->getStatus() == '3' || $CI->getStatus() == '1'): ?>
			<li>
              <a href="<?php echo site_url('booking')?>">
                <i class="fa fa-file-text"></i> <span>Booking Online</span> <i class="fa pull-right"></i>
              </a>
            </li>
			<!-- <?php endif; ?>	<?php if($CI->getStatus() == '3' || $CI->getStatus() == '1'): ?>
			<li>
