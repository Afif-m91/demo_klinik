								...
								<form class="form-inline" method="get" action="<?php echo site_url("pelanggan")?>" >
									 ...
									 <span class="caret"></span></button>
										<ul class="dropdown-menu">
											<li><a href="<?php echo site_url("pelanggan/export_excel")?>" class="fa fa-file-excel-o" style="color:green">
											&nbsp;Export Excel </a></li>
											<li><a href="<?php echo base_url("pelanggan_pdf/cetak_pdf.php") ?>"class="fa fa-file-pdf-o" style="color:red" 
											target="_blank">&nbsp; Export PDF</a></li>
												<!-- <li><?php echo anchor('pelanggan_pdf/cetak_pdf.php','Export PDF', 
