					...
					<div class="box-header">
						...
						<?php foreach($data as $dt): ?>
						  <tr>
							...
							<th>
								<a class="btn btn-warning btn-xs" href="<?php echo site_url("barang/manage")."/". $dt['id_barang']; ?>">
								<span class="glyphicon glyphicon-edit"></span></a>
								<a class="btn btn-danger btn-xs" data-href="<?php echo site_url("barang/delete")."/". $dt['id_barang'];?>"
