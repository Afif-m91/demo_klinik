...
<section id="section14" class="section-margine blog-list">
  <div class="container">
    ...
    <?php $data=mysqli_query($connect,"select * from berita 
     ...
     ?> -->
        <!-- <div class="col-lg-10"> -->
            <h3>Konsultasi Psikologi mengenai ABK </h3>
        <!-- </div> -->
       <!-- <thead>
         ...
         $query = mysqli_query($connect, "SELECT * FROM abk ORDER BY id_abk ASC");
    ...
    ?> -->
         <tr>
           ...
           <!-- <td><?php echo $data ['nama_abk'];?></td> -->
           <td><?php echo $data ['isi_abk']; ?></td>
