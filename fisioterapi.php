  ...
  <div class="container">
    ...
    <?php $data=mysqli_query($connect,"select * from berita 
     ...
     ?> -->
       ...
       <thead>
         ...
         // {}
         $no = 1 ;
         $query = mysqli_query($connect, "SELECT * FROM fisioterapi ORDER BY tarif ASC");
    ...
    ?> -->
         <tr>
           ...
           <td><?php echo $data ['nama_fisioterapi'];?></td>
...
?>     
          ...
          <div class="comment-form-container wow fadeInLeft">
           <div class="col-lg-12">
                <p align ="justify"># Tarif sudah termasuk Layanan Jasa Homecare minimal pelayanan di rumah Rp 250.000 
                    (Jika kurang dari minimal tarif tersebut akan dikenakan tambahan biaya transportasi)</p>
                
                <p align ="justify"># Untuk Paket Mingguan dan Bulanan tarif akan lebih hemat lagi dan disesuaikan  dengan kebutuhan 
